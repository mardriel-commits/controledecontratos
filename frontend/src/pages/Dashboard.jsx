      ...
      <div className="grid">
        <div className="card">
          ...
          <div className="kpis">
            ...
            <div className="kpi">
              <div className="small">Vencem ≤ 30</div>
              <div className="v">{kpis.ate30}</div>
            </div>
            <div className="kpi">
              <div className="small">Vencem ≤ 15</div>
          ...
          <div style={{ marginTop: 16 }}>
            <div className="small" style={{ marginBottom: 8 }}>
              Buscar (contrato, empresa ou CNPJ)
            </div>
            <input
              className="input"
              value={q}
              onChange={e => setQ(e.target.value)}
              placeholder="Ex.: CT-001, Empresa X, 123..."
            />
          </div>

          <div className="small" style={{ marginTop: 12 }}>
            {isAdmin && 'Você tem acesso completo: contratos, usuários, auditoria e alertas.'}
            {isGestor && 'Você pode consultar contratos e lançar movimentações nos contratos vinculados a você.'}
            {isFiscal && 'Você pode consultar contratos e lançar movimentações nos contratos vinculados a você.'}
            {isConsulta && 'Seu perfil é somente leitura.'}
          </div>

          {error && (
            <div style={{ marginTop: 12, fontSize: 13, fontWeight: 800, color: '#b42318' }}>
              {error}
            </div>
          )}
        </div>
        ...
        <div className="card">
          ...
          <table className="table">
            ...
            <tbody>
              ...
              {filtered.length === 0 && (
                <tr>
                  <td colSpan="7" className="small" style={{ padding: 16, opacity: 0.8 }}>
                    Nenhum registro.
                  </td>
                </tr>
              )}
